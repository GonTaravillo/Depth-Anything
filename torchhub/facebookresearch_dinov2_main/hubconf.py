...
def dinov2_vitn14(*, pretrained: bool = False, weights: Union[Weights, str] = Weights.LVD142M, **kwargs):
    """
    DINOv2 ViT-N/14 model (optionally) pretrained on the LVD-142M dataset.
    """
...
def dinov2_vitn14_reg(*, pretrained: bool = False, weights: Union[Weights, str] = Weights.LVD142M, **kwargs):
    """
    DINOv2 ViT-N/14 model with registers (optionally) pretrained on the LVD-142M dataset.
    """
    return _make_dinov2_model(
        arch_name="vit_nano",
        pretrained=pretrained,
